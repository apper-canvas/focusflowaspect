    ...
    <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-3">
            ...
            <Button variant="secondary" size="sm">
                <ApperIcon name="Download" size={16} className="mr-1" />Export
                          </Button>
        </div>
    </div>
...
const GoalProgressDisplay = () => {
  ...
  return (
    <Card className="p-6">
    <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900 font-display">Goal Progress Tracking
                    </h3>
        <Button size="sm" variant="secondary" onClick={() => navigate("/goals")}>
            <ApperIcon name="Settings" size={16} className="mr-2" />Manage Goals
                    </Button>
    </div>
    <div className="space-y-6">
        {/* Daily Goals Section */}
        <div>
            <h4 className="font-semibold text-gray-800 mb-4 flex items-center">
                <ApperIcon name="Sun" size={16} className="mr-2 text-warning" />Daily Goals Progress
                          </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                    className={`p-4 bg-gradient-to-r from-${getProgressColor(dailyProgress)}/5 to-${getProgressColor(dailyProgress)}/10 rounded-lg border border-${getProgressColor(dailyProgress)}/20`}>
                ...
                <div
                    className={`p-4 bg-gradient-to-r from-${getProgressColor(focusSessionsProgress)}/5 to-${getProgressColor(focusSessionsProgress)}/10 rounded-lg border border-${getProgressColor(focusSessionsProgress)}/20`}>
                    <div className="flex justify-between text-sm mb-2">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 mb-2">
                        <div
                            ...
                            style={{
                                width: `${Math.min(focusSessionsProgress, 100)}%`
                            }} />
                    </div>
                    <div className="flex justify-between text-xs text-gray-500">
        ...
        <div>
            <h4 className="font-semibold text-gray-800 mb-4 flex items-center">
                <ApperIcon name="Calendar" size={16} className="mr-2 text-primary" />Weekly Goals Progress
                          </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                    className={`p-4 bg-gradient-to-r from-${getProgressColor(weeklyProgress)}/5 to-${getProgressColor(weeklyProgress)}/10 rounded-lg border border-${getProgressColor(weeklyProgress)}/20`}>
                    <div className="flex justify-between text-sm mb-2">
                ...
                {goals.weekly.learningHours && <div
                    className="p-4 bg-gradient-to-r from-info/5 to-info/10 rounded-lg border border-info/20">
                    <div className="flex justify-between text-sm mb-2">
        ...
        {goals.projects && goals.projects.length > 0 && <div>
            <h4 className="font-semibold text-gray-800 mb-4 flex items-center">
                <ApperIcon name="Target" size={16} className="mr-2 text-secondary" />Project Goals Progress
                            </h4>
                ...
                {goals.projects.map((project, index) => {
                    ...
                    return (
                        <div
                            ...
                            className={`p-4 bg-gradient-to-r from-${priorityColor}/5 to-${priorityColor}/10 rounded-lg border border-${priorityColor}/20`}>
                            <div className="flex justify-between text-sm mb-2">
        ...
        <div
            ...
            <h5 className="font-medium text-gray-800 mb-3 flex items-center">
                <ApperIcon name="TrendingUp" size={16} className="mr-2 text-success" />Weekly Achievement Summary
                          </h5>
            <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                    <div
                        className={`text-2xl font-bold ${dailyProgress >= 80 ? "text-success" : "text-warning"}`}>
                ...
                <div>
                    <div
                        className={`text-2xl font-bold ${weeklyProgress >= 80 ? "text-success" : "text-warning"}`}>
    ...
    <Card className="p-6 mt-6">
        <h3 className="text-lg font-semibold text-gray-900 font-display mb-4">Achievements & Insights
                    </h3>
        <div className="space-y-4">
            <div
                className="flex items-center space-x-3 p-3 bg-gradient-to-r from-success/10 to-success/5 rounded-lg border border-success/20">
            ...
            <div
                className="flex items-center space-x-3 p-3 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg">
            ...
            <div
                className="flex items-center space-x-3 p-3 bg-gradient-to-r from-warning/10 to-warning/5 rounded-lg">
            ...
            <div
                className="flex items-center space-x-3 p-3 bg-gradient-to-r from-info/10 to-info/5 rounded-lg">
